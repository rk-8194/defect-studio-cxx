...
unordered_map<string, int> TaskManager::registeredArguments = {
    {"INPUT_FILE", 1}, {"OUTPUT_DIR", 1}, {"OUTPUT_FILE", 1}, {"POSITION", 3}, {"ROTATION", 3}, {"FROM", 1}, {"TO", 1},
    {"AMOUNT", 1}, {"FRACTION", 1}, {"PERCENT", 1}, {"AMOUNT", 1}, {"STEPS", 1}, {"REPEAT", 1}, {"MIN", 1}, {"MAX", 1},
    {"DIM", 1}, {"ELEMENT", 1}, {"BRAVAIS", 1}, {"CLUSTER", 1}, {"ALL", 0}, {"DELETE", 0}, {"RANDOM", 1}, {"AXIS", 3},
    {"BOX", 3}, {"SELECT", 1} };
